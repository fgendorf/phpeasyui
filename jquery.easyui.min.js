...
var vv=$.map(_c14,function(_c16){
return String(_c16);
});
vv=$.grep(vv,function(v,_c17){
return _c17===$.inArray(v,vv);
});
var _c18=grid.treegrid("getSelected");
if(_c18){
grid.treegrid("unselect",_c18[opts.idField]);
}
...
ss.push(_c1a(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
function _c1a(_c1b,a){
var item=$.easyui.getArrayItem(a,opts.idField,_c1b);
return item?_c19(item):undefined;
};
function _c19(row){
return row[opts.textField||""]||row[opts.treeField];
};
};
function _c1c(_c1d,q){
var _c1e=$.data(_c1d,"combotreegrid");
var opts=_c1e.options;
var grid=_c1e.grid;
_c1e.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
qq=$.grep(qq,function(q){
return $.trim(q)!="";
});
...
if(opts.filter.call(_c1d,q,row)){
...
function _c1f(vv){
if(!opts.reversed){
$(_c1d).combotreegrid("setValues",vv);
}
};
};
function _c20(_c21){
var _c22=$.data(_c21,"combotreegrid");
...
$(_c21).combotreegrid("setValues",vv);
if(!opts.multiple){
$(_c21).combotreegrid("hidePanel");
}
};
$.fn.combotreegrid=function(_c23,_c24){
if(typeof _c23=="string"){
var _c25=$.fn.combotreegrid.methods[_c23];
if(_c25){
return _c25(this,_c24);
}else{
return this.combo(_c23,_c24);
}
}
_c23=_c23||{};
return this.each(function(){
var _c26=$.data(this,"combotreegrid");
if(_c26){
$.extend(_c26.options,_c23);
}else{
_c26=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_c23)});
}
_c06(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _c27=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_c27.width,height:_c27.height,originalValue:_c27.originalValue,disabled:_c27.disabled,readonly:_c27.readonly});
},grid:function(jq){
return $.data(jq[0],"combotreegrid").grid;
},setValues:function(jq,_c28){
return jq.each(function(){
var opts=$(this).combotreegrid("options");
if($.isArray(_c28)){
_c28=$.map(_c28,function(_c29){
if(_c29&&typeof _c29=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_c29);
return _c29[opts.idField];
}else{
return _c29;
}
});
...
},setValue:function(jq,_c2a){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_c2a)?_c2a:[_c2a]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_c2b){
var t=$(_c2b);
return $.extend({},$.fn.combo.parseOptions(_c2b),$.fn.treegrid.parseOptions(_c2b),$.parser.parseOptions(_c2b,["mode",{limitToGrid:"boolean"}]));
};
...
$.fn.combo.defaults.inputEvents.blur(e);
var _c2c=e.data.target;
var opts=$(_c2c).combotreegrid("options");
if(opts.limitToGrid){
_c20(_c2c);
}
}}),filter:function(q,row){
...
(function($){
function _c2d(_c2e){
var _c2f=$.data(_c2e,"tagbox");
var opts=_c2f.options;
$(_c2e).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_c30,_c31){
_c32();
$(this).combobox("hidePanel");
opts.onChange.call(_c2e,_c30,_c31);
},onResizing:function(_c33,_c34){
var _c35=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
var _c36=tb.outerWidth();
tb.css({height:"",paddingLeft:_c35.css("marginLeft"),paddingRight:_c35.css("marginRight")});
_c35.css("margin",0);
tb._outerWidth(_c36);
_c49(_c2e);
_c3b(this);
opts.onResizing.call(_c2e,_c33,_c34);
},onLoadSuccess:function(data){
_c32();
opts.onLoadSuccess.call(_c2e,data);
}}));
_c32();
_c49(_c2e);
function _c32(){
$(_c2e).next().find(".tagbox-label").remove();
var _c37=$(_c2e).tagbox("textbox");
var ss=[];
$.map($(_c2e).tagbox("getValues"),function(_c38,_c39){
var row=opts.finder.getRow(_c2e,_c38);
var text=opts.tagFormatter.call(_c2e,_c38,row);
var cs={};
var css=opts.tagStyler.call(_c2e,_c38,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _c3a=$("<span class=\"tagbox-label\"></span>").insertBefore(_c37).html(text);
_c3a.attr("tagbox-index",_c39);
_c3a.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_c3a);
});
_c3b(_c2e);
$(_c2e).combobox("setText","");
};
};
function _c3b(_c3c,_c3d){
var span=$(_c3c).next();
var _c3e=_c3d?$(_c3d):span.find(".tagbox-label");
if(_c3e.length){
var _c3f=$(_c3c).tagbox("textbox");
var _c40=$(_c3e[0]);
var _c41=_c40.outerHeight(true)-_c40.outerHeight();
var _c42=_c3f.outerHeight()-_c41*2;
_c3e.css({height:_c42+"px",lineHeight:_c42+"px"});
var _c43=span.find(".textbox-addon").css("height","100%");
_c43.find(".textbox-icon").css("height","100%");
...
var _c46=parseInt($(e.target).parent().attr("tagbox-index"));
var _c47=$(_c45).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_c45,_c47[_c46])==false){
return;
}
opts.onRemoveTag.call(_c45,_c47[_c46]);
_c47.splice(_c46,1);
$(_c45).tagbox("setValues",_c47);
}else{
var _c48=$(e.target).closest(".tagbox-label");
if(_c48.length){
var _c46=parseInt(_c48.attr("tagbox-index"));
var _c47=$(_c45).tagbox("getValues");
opts.onClickTag.call(_c45,_c47[_c46]);
}
}
...
var _c4b=$(_c4a).tagbox("textbox");
var span=$(_c4a).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_c4b.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_c4b.css("fontFamily"),fontSize:_c4b.css("fontSize"),fontWeight:_c4b.css("fontWeight"),whiteSpace:"nowrap"});
var _c4c=_c4d(_c4b.val());
var _c4e=_c4d(opts.prompt||"");
tmp.remove();
var _c4f=Math.min(Math.max(_c4c,_c4e)+20,span.width());
_c4b._outerWidth(_c4f);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _c4d(val){
...
if(opts.limitToList){
var _c52=t.tagbox("panel");
var item=_c52.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_c51,item);
var _c53=row[opts.valueField];
$(_c51).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_c53);
}
$(_c51).tagbox("hidePanel");
}else{
var v=$.trim($(_c51).tagbox("getText"));
if(v!==""){
var _c54=$(_c51).tagbox("getValues");
_c54.push(v);
$(_c51).tagbox("setValues",_c54);
}
}
};
function _c55(_c56,_c57){
$(_c56).combobox("setText","");
_c49(_c56);
$(_c56).combobox("setValues",_c57);
$(_c56).combobox("setText","");
$(_c56).tagbox("validate");
};
$.fn.tagbox=function(_c58,_c59){
if(typeof _c58=="string"){
var _c5a=$.fn.tagbox.methods[_c58];
if(_c5a){
return _c5a(this,_c59);
}else{
return this.combobox(_c58,_c59);
}
}
_c58=_c58||{};
return this.each(function(){
var _c5b=$.data(this,"tagbox");
if(_c5b){
$.extend(_c5b.options,_c58);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_c58)});
}
_c2d(this);
_c44(this);
});
...
var _c5c=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_c5c.width,height:_c5c.height,originalValue:_c5c.originalValue,disabled:_c5c.disabled,readonly:_c5c.readonly});
},setValues:function(jq,_c5d){
return jq.each(function(){
_c55(this,_c5d);
});
},reset:function(jq){
...
$.fn.tagbox.parseOptions=function(_c5e){
return $.extend({},$.fn.combobox.parseOptions(_c5e),$.parser.parseOptions(_c5e,[]));
};
$.fn.tagbox.defaults=$.extend({},$.fn.combobox.defaults,{hasDownArrow:false,multiple:true,reversed:true,selectOnNavigation:false,tipOptions:$.extend({},$.fn.textbox.defaults.tipOptions,{showDelay:200}),val:function(_c5f){
var vv=$(_c5f).parent().prev().tagbox("getValues");
if($(_c5f).is(":focus")){
vv.push($(_c5f).val());
}
return vv.join(",");
},inputEvents:$.extend({},$.fn.combo.defaults.inputEvents,{blur:function(e){
var _c60=e.data.target;
var opts=$(_c60).tagbox("options");
if(opts.limitToList){
_c50(_c60);
}
...
}}),tagFormatter:function(_c61,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_c61;
},tagStyler:function(_c62,row){
return "";
},onClickTag:function(_c63){
},onBeforeRemoveTag:function(_c64){
},onRemoveTag:function(_c65){
}});
})(jQuery);
(function($){
function _c66(_c67){
var _c68=$.data(_c67,"datebox");
var opts=_c68.options;
$(_c67).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_c69(this);
_c6a(this);
_c6b(this);
_c79(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_c68.calendar){
var _c6c=$(_c67).combo("panel").css("overflow","hidden");
_c6c.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_c6c);
...
_c68.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_c68.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _c6d=this.target;
var opts=$(_c6d).datebox("options");
opts.onSelect.call(_c6d,date);
_c79(_c6d,opts.formatter.call(_c6d,date));
$(_c6d).combo("hidePanel");
}});
}
$(_c67).combo("textbox").parent().addClass("datebox");
$(_c67).datebox("initValue",opts.value);
function _c69(_c6e){
var opts=$(_c6e).datebox("options");
var _c6f=$(_c6e).combo("panel");
_c6f.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _c70=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_c70].handler.call(e.target,_c6e);
}
});
};
function _c6a(_c71){
var _c72=$(_c71).combo("panel");
if(_c72.children("div.datebox-button").length){
return;
}
var _c73=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_c72);
var tr=_c73.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_c71):btn.text).appendTo(td);
...
var cc=_c75.children("div.datebox-calendar-inner");
_c75.children()._outerWidth(_c75.width());
_c68.calendar.appendTo(cc);
_c68.calendar[0].target=_c74;
if(opts.panelHeight!="auto"){
var _c76=_c75.height();
_c75.children().not(cc).each(function(){
_c76-=$(this).outerHeight();
});
cc._outerHeight(_c76);
}
_c68.calendar.calendar("resize");
};
};
function _c77(_c78,q){
_c79(_c78,q,true);
};
function _c7a(_c7b){
var _c7c=$.data(_c7b,"datebox");
var opts=_c7c.options;
var _c7d=_c7c.calendar.calendar("options").current;
if(_c7d){
_c79(_c7b,opts.formatter.call(_c7b,_c7d));
$(_c7b).combo("hidePanel");
}
};
function _c79(_c7e,_c7f,_c80){
var _c81=$.data(_c7e,"datebox");
var opts=_c81.options;
var _c82=_c81.calendar;
_c82.calendar("moveTo",opts.parser.call(_c7e,_c7f));
if(_c80){
$(_c7e).combo("setValue",_c7f);
}else{
if(_c7f){
_c7f=opts.formatter.call(_c7e,_c82.calendar("options").current);
}
$(_c7e).combo("setText",_c7f).combo("setValue",_c7f);
}
};
$.fn.datebox=function(_c83,_c84){
if(typeof _c83=="string"){
var _c85=$.fn.datebox.methods[_c83];
if(_c85){
return _c85(this,_c84);
}else{
return this.combo(_c83,_c84);
}
}
_c83=_c83||{};
return this.each(function(){
var _c86=$.data(this,"datebox");
if(_c86){
$.extend(_c86.options,_c83);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_c83)});
}
_c66(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _c87=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_c87.width,height:_c87.height,originalValue:_c87.originalValue,disabled:_c87.disabled,readonly:_c87.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_c88){
return jq.each(function(){
var opts=$(this).datebox("options");
var _c89=opts.value;
if(_c89){
_c89=opts.formatter.call(this,opts.parser.call(this,_c89));
}
$(this).combo("initValue",_c89).combo("setText",_c89);
});
},setValue:function(jq,_c8a){
return jq.each(function(){
_c79(this,_c8a);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_c8b){
return $.extend({},$.fn.combo.parseOptions(_c8b),$.parser.parseOptions(_c8b,["sharedCalendar"]));
};
...
_c77(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_c8c){
return $(_c8c).datebox("options").currentText;
},handler:function(_c8d){
var opts=$(_c8d).datebox("options");
var now=new Date();
var _c8e=new Date(now.getFullYear(),now.getMonth(),now.getDate());
$(_c8d).datebox("calendar").calendar({year:_c8e.getFullYear(),month:_c8e.getMonth()+1,current:_c8e});
opts.onSelect.call(_c8d,_c8e);
_c7a(_c8d);
}},{text:function(_c8f){
return $(_c8f).datebox("options").closeText;
...
var _c91=$(this).datebox("calendar").calendar("options");
if(!s){
return new _c91.Date();
}
var ss=s.split("/");
...
(function($){
function _c92(_c93){
var _c94=$.data(_c93,"datetimebox");
var opts=_c94.options;
$(_c93).datebox($.extend({},opts,{onShowPanel:function(){
var _c95=$(this).datetimebox("getValue");
_c9b(this,_c95,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_c93).removeClass("datebox-f").addClass("datetimebox-f");
$(_c93).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_c94.spinner){
var _c96=$(_c93).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_c96.children("div.datebox-calendar-inner"));
_c94.spinner=p.children("input");
}
_c94.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator,hour12:opts.hour12});
$(_c93).datetimebox("initValue",opts.value);
};
function _c97(_c98){
var c=$(_c98).datetimebox("calendar");
var t=$(_c98).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _c99(_c9a,q){
_c9b(_c9a,q,true);
};
function _c9c(_c9d){
var opts=$.data(_c9d,"datetimebox").options;
var date=_c97(_c9d);
_c9b(_c9d,opts.formatter.call(_c9d,date));
$(_c9d).combo("hidePanel");
};
function _c9b(_c9e,_c9f,_ca0){
var opts=$.data(_c9e,"datetimebox").options;
$(_c9e).combo("setValue",_c9f);
if(!_ca0){
if(_c9f){
var date=opts.parser.call(_c9e,_c9f);
$(_c9e).combo("setText",opts.formatter.call(_c9e,date));
$(_c9e).combo("setValue",opts.formatter.call(_c9e,date));
}else{
$(_c9e).combo("setText",_c9f);
}
}
var date=opts.parser.call(_c9e,_c9f);
$(_c9e).datetimebox("calendar").calendar("moveTo",date);
$(_c9e).datetimebox("spinner").timespinner("setValue",_ca1(date));
function _ca1(date){
function _ca2(_ca3){
return (_ca3<10?"0":"")+_ca3;
};
var tt=[_ca2(date.getHours()),_ca2(date.getMinutes())];
if(opts.showSeconds){
tt.push(_ca2(date.getSeconds()));
}
return tt.join($(_c9e).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_ca4,_ca5){
if(typeof _ca4=="string"){
var _ca6=$.fn.datetimebox.methods[_ca4];
if(_ca6){
return _ca6(this,_ca5);
}else{
return this.datebox(_ca4,_ca5);
}
}
_ca4=_ca4||{};
return this.each(function(){
var _ca7=$.data(this,"datetimebox");
if(_ca7){
$.extend(_ca7.options,_ca4);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_ca4)});
}
_c92(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _ca8=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_ca8.originalValue,disabled:_ca8.disabled,readonly:_ca8.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_ca9){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _caa=opts.value;
if(_caa){
_caa=opts.formatter.call(this,opts.parser.call(this,_caa));
}
$(this).combo("initValue",_caa).combo("setText",_caa);
});
},setValue:function(jq,_cab){
return jq.each(function(){
_c9b(this,_cab);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_cac){
var t=$(_cac);
return $.extend({},$.fn.datebox.parseOptions(_cac),$.parser.parseOptions(_cac,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_c99(this,q);
}},buttons:[{text:function(_cad){
return $(_cad).datetimebox("options").currentText;
},handler:function(_cae){
var opts=$(_cae).datetimebox("options");
_c9b(_cae,opts.formatter.call(_cae,new Date()));
$(_cae).datetimebox("hidePanel");
}},{text:function(_caf){
return $(_caf).datetimebox("options").okText;
},handler:function(_cb0){
_c9c(_cb0);
}},{text:function(_cb1){
return $(_cb1).datetimebox("options").closeText;
},handler:function(_cb2){
$(_cb2).datetimebox("hidePanel");
}}],formatter:function(date){
if(!date){
return "";
}
...
var dt=s.split(" ");
var _cb3=$.fn.datebox.defaults.parser.call(this,dt[0]);
if(dt.length<2){
return _cb3;
}
var _cb4=$.fn.timespinner.defaults.parser.call($(this).datetimebox("spinner")[0],dt[1]+(dt[2]?" "+dt[2]:""));
return new Date(_cb3.getFullYear(),_cb3.getMonth(),_cb3.getDate(),_cb4.getHours(),_cb4.getMinutes(),_cb4.getSeconds());
}});
})(jQuery);
(function($){
function init(_cb5){
var _cb6=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_cb5);
var t=$(_cb5);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_cb6.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_cb6.bind("_resize",function(e,_cb7){
if($(this).hasClass("easyui-fluid")||_cb7){
_cb8(_cb5);
}
return false;
});
...
if(_cba){
if(_cba.width){
opts.width=_cba.width;
}
if(_cba.height){
opts.height=_cba.height;
}
}
_cbc._size(opts);
if(opts.mode=="h"){
_cbc.css("height","");
_cbc.children("div").css("height","");
}else{
_cbc.css("width","");
_cbc.children("div").css("width","");
_cbc.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_cbc._outerHeight());
}
_cbd(_cb9);
};
function _cbe(_cbf){
...
_cc2(aa);
function _cc2(aa){
var rule=_cc1.find("div.slider-rule");
var _cc3=_cc1.find("div.slider-rulelabel");
rule.empty();
_cc3.empty();
for(var i=0;i<aa.length;i++){
var _cc4=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_cc4);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_cc3);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_cc4,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_cc4,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
_cc8.removeClass("slider-h slider-v slider-disabled");
_cc8.addClass(opts.mode=="h"?"slider-h":"slider-v");
_cc8.addClass(opts.disabled?"slider-disabled":"");
var _cc9=_cc8.find(".slider-inner");
_cc9.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_cc9.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_cc8.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_cc7.isDragging=true;
opts.onSlideStart.call(_cc6,opts.value);
},onStopDrag:function(e){
_ccb(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_cc6,opts.value);
opts.onComplete.call(_cc6,opts.value);
_cc7.isDragging=false;
}});
_cc8.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_cc7.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_ccb(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_cc6,opts.value);
});
function _ccc(_ccd){
var dd=String(opts.step).split(".");
var dlen=dd.length>1?dd[1].length:0;
return parseFloat(_ccd.toFixed(dlen));
};
function _ccb(pos,_cce){
var _ccf=_cd0(_cc6,pos);
var s=Math.abs(_ccf%opts.step);
if(s<opts.step/2){
_ccf-=s;
}else{
_ccf=_ccf-s+opts.step;
}
_ccf=_ccc(_ccf);
if(opts.range){
var v1=opts.value[0];
...
if(_cce){
var _cd1=$(_cce).nextAll(".slider-handle").length>0;
if(_ccf<=v2&&_cd1){
v1=_ccf;
}else{
if(_ccf>=v1&&(!_cd1)){
...
_ccf<m?v1=_ccf:v2=_ccf;
}
}
}
$(_cc6).slider("setValues",[v1,v2]);
}else{
$(_cc6).slider("setValue",_ccf);
}
};
};
function _cd2(_cd3,_cd4){
var _cd5=$.data(_cd3,"slider");
var opts=_cd5.options;
var _cd6=_cd5.slider;
var _cd7=$.isArray(opts.value)?opts.value:[opts.value];
var _cd8=[];
if(!$.isArray(_cd4)){
_cd4=$.map(String(_cd4).split(opts.separator),function(v){
return parseFloat(v);
});
}
_cd6.find(".slider-value").remove();
var name=$(_cd3).attr("sliderName")||"";
for(var i=0;i<_cd4.length;i++){
var _cd9=_cd4[i];
if(_cd9<opts.min){
_cd9=opts.min;
}
...
var _cda=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_cd6);
_cda.attr("name",name);
_cda.val(_cd9);
_cd8.push(_cd9);
var _cdb=_cd6.find(".slider-handle:eq("+i+")");
var tip=_cdb.next();
var pos=_cdc(_cd3,_cd9);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_cd3,_cd9));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _cdd="left:"+pos+"px;";
_cdb.attr("style",_cdd);
tip.attr("style",_cdd+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _cdd="top:"+pos+"px;";
_cdb.attr("style",_cdd);
tip.attr("style",_cdd+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_cd8:_cd8[0];
$(_cd3).val(opts.range?_cd8.join(opts.separator):_cd8[0]);
if(_cd7.join(",")!=_cd8.join(",")){
opts.onChange.call(_cd3,opts.value,(opts.range?_cd7:_cd7[0]));
}
};
function _cbd(_cde){
var opts=$.data(_cde,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_cd2(_cde,opts.value);
opts.onChange=fn;
};
function _cdc(_cdf,_ce0){
var _ce1=$.data(_cdf,"slider");
var opts=_ce1.options;
var _ce2=_ce1.slider;
var size=opts.mode=="h"?_ce2.width():_ce2.height();
var pos=opts.converter.toPosition.call(_cdf,_ce0,size);
if(opts.mode=="v"){
pos=_ce2.height()-pos;
}
if(opts.reversed){
...
function _cd0(_ce3,pos){
var _ce4=$.data(_ce3,"slider");
var opts=_ce4.options;
var _ce5=_ce4.slider;
var size=opts.mode=="h"?_ce5.width():_ce5.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _ce6=opts.converter.toValue.call(_ce3,pos,size);
return _ce6;
};
$.fn.slider=function(_ce7,_ce8){
if(typeof _ce7=="string"){
return $.fn.slider.methods[_ce7](this,_ce8);
}
_ce7=_ce7||{};
return this.each(function(){
var _ce9=$.data(this,"slider");
if(_ce9){
$.extend(_ce9.options,_ce7);
}else{
_ce9=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_ce7),slider:init(this)});
$(this)._propAttr("disabled",false);
}
...
return jq.slider("options").value;
},setValue:function(jq,_ceb){
return jq.each(function(){
_cd2(this,[_ceb]);
});
},setValues:function(jq,_cec){
return jq.each(function(){
_cd2(this,_cec);
});
},clear:function(jq){
...
_cd2(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_ced){
var t=$(_ced);
return $.extend({},$.parser.parseOptions(_ced,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_cee){
return _cee;
},converter:{toPosition:function(_cef,size){
var opts=$(this).slider("options");
var p=(_cef-opts.min)/(opts.max-opts.min)*size;
return p;
},toValue:function(pos,size){
var opts=$(this).slider("options");
var v=opts.min+(opts.max-opts.min)*(pos/size);
return v;
}},onChange:function(_cf0,_cf1){
},onSlideStart:function(_cf2){
},onSlideEnd:function(_cf3){
},onComplete:function(_cf4){
}};
})(jQuery);
